...
`python scripts/publishRelease.py` creates `documentation/releases/vVERSION.md` when the channel is chosen. It copies those bullets under `## Changes` (never a “Working Notes” heading), then resets the scratch file. If `vVERSION.md` already exists, that file is the GitHub Release body as-is.

...
ROWS = (
    ...
    ("overlayPrimaryFlag", "Overlay primary flag",
     "Query list: overlay primary (paired Data ID).", "fg"),
    ("overlaySecondaryFlag", "Overlay secondary flag",
     "Query list: overlay secondary (paired Data ID).", "fg"),
...
_SHARED = {
    ...
    "overlayPrimaryFlag": {"fg": "#308CC6"},
    "overlaySecondaryFlag": {"fg": "#2E8B57"},
